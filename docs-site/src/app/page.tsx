      ...
      <header className="fixed top-0 w-full z-50 bg-[#0a0a0b]/90 backdrop-blur-xl border-b border-[#1f1f23]">
        <nav className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="/" className="flex items-center gap-2.5 font-bold text-lg no-underline text-[#fafafa]">
            <svg width="32" height="32" viewBox="0 0 120 120" fill="none"><line x1="22" y1="90" x2="78" y2="18" stroke="#22c55e" strokeWidth="5" strokeLinecap="round"/><path d="M22 90L8 102 L0 114" stroke="#22c55e" strokeWidth="5" strokeLinecap="round"/><path d="M22 90L12 108 L6 120" stroke="#4ade80" strokeWidth="4.5" strokeLinecap="round"/><path d="M22 90L20 110 L18 120" stroke="#22c55e" strokeWidth="4" strokeLinecap="round"/><path d="M22 90L28 108 L30 120" stroke="#4ade80" strokeWidth="3.5" strokeLinecap="round"/><path d="M22 90L36 104 L42 120" stroke="#22c55e" strokeWidth="3" strokeLinecap="round"/><ellipse cx="22" cy="90" rx="6" ry="4" fill="#16a34a" transform="rotate(-55 22 90)"/><ellipse cx="26" cy="85" rx="5" ry="3" fill="#16a34a" transform="rotate(-55 26 85)"/><line x1="85" y1="15" x2="105" y2="5" stroke="#4ade80" strokeWidth="2" strokeLinecap="round" opacity="0.6"/><line x1="88" y1="22" x2="110" y2="18" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" opacity="0.5"/><line x1="82" y1="10" x2="100" y2="0" stroke="#4ade80" strokeWidth="1.5" strokeLinecap="round" opacity="0.4"/><circle cx="100" cy="8" r="2" fill="#22c55e" opacity="0.7"/><circle cx="108" cy="15" r="1.5" fill="#4ade80" opacity="0.6"/><circle cx="96" cy="4" r="1" fill="#22c55e" opacity="0.5"/></svg>
            Nimbus
          </a>
