...
const sidebar = [
  { title: 'Quick Start', href: '/en/docs/quickstart' },
  { title: 'Architecture', href: '/en/docs/architecture' },
  { title: 'Deployment', href: '/en/docs/deployment' },
  { title: 'Configuration', href: '/en/docs/configuration' },
  { title: 'CLI', href: '/en/docs/cli' },
  { title: 'API Reference', href: '/en/docs/api' },
  { title: 'FAQ', href: '/en/docs/faq' },
]
    ...
    <div className="min-h-screen bg-[#0a0a0b]">
      <header className="fixed top-0 w-full z-50 bg-[#0a0a0b]/90 backdrop-blur-xl border-b border-[#1f1f23]">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 text-sm">
            <Link href="/en/docs" className="text-[#22c55e] font-medium no-underline">EN</Link>
            <Link href="/pt/docs" className="text-[#a1a1aa] hover:text-white no-underline transition">PT</Link>
      ...
      <div className="flex pt-16">
        <aside className="fixed top-16 left-0 w-56 h-[calc(100vh-4rem)] border-r border-[#1f1f23] bg-[#0a0a0b] overflow-y-auto hidden lg:block">
          <nav className="p-6">
            <Link href="/en/docs" className="block text-sm font-semibold text-[#fafafa] mb-6 no-underline hover:text-[#22c55e] transition">Documentation</Link>
            {sidebar.map((item) => (
