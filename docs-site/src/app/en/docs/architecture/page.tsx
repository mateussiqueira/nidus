...
└──────────────────────────────────────────────────────────┘`}
        ...
        <section className="mb-12">
          ...
          <p className="text-[#a1a1aa] mb-4">The main API that manages authentication, projects, deploys, and webhooks.</p>
          
          <h3 className="text-xl font-medium mb-3">Deploy Worker (Go)</h3>
          <p className="text-[#a1a1aa] mb-4">Worker that processes builds and deploys with concurrent goroutine pool.</p>
          
          <h3 className="text-xl font-medium mb-3">Data Plane (Rust)</h3>
          <p className="text-[#a1a1aa] mb-4">High-performance reverse proxy with rate limiting and TLS.</p>
          
          <h3 className="text-xl font-medium mb-3">Dashboard (Next.js)</h3>
          <p className="text-[#a1a1aa]">User interface to manage projects and deployments.</p>
        </section>
