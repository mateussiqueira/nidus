...
features:
  ...
  - title: CLI
    details: npx nidus deploy. Simple as that.
  - title: Go Worker
...
Nidus is an open-source PaaS inspired by Vercel, Railway, and Coolify.
...
```
Your code → Git push → Nidus detects → Docker build → Run container → URL ready
```
